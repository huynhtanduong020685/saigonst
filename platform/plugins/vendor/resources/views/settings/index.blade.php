      ...
      <div class="row">
        ...
        <div class="col-12 col-md-9">
            <div class="main-dashboard-form">
                ...
                <div class="row">
                    <div class="col-12">
                        <h4 class="with-actions">{{ trans('plugins/vendor::dashboard.account_field_title') }}</h4>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-lg-8 order-lg-0">
                        ...
                        <!-- Name -->
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" name="email" id="email" disabled="disabled" placeholder="{{ trans('plugins/vendor::dashboard.email_placeholder') }}" required value="{{ old('email') ?? $user->email }}">
                                @if ($user->confirmed_at)
                                    <small class="f7 green">{{ trans('plugins/vendor::dashboard.verified') }}<i class="ml1 far fa-check-circle"></i></small>
                                @else
                    ...
                    <strong>{{ $errors->has('dob') ? $errors->first('dob') : '' }}</strong>
                            ...
                            <!-- Gender -->
                            <div class="form-group">
                                <label for="gender">{{ trans('plugins/vendor::dashboard.gender') }}</label>
                                <select class="form-control" name="gender" id="gender">
                                    <option value="male" {{ $user->gender == 'male' ? 'selected' : '' }}>{{ trans('plugins/vendor::dashboard.gender_male') }}</option>
                                    <option value="female" {{ $user->gender == 'female' ? 'selected' : '' }}>{{ trans('plugins/vendor::dashboard.gender_female') }}</option>
                                    <option value="other" {{ $user->gender == 'other' ? 'selected' : '' }}>{{ trans('plugins/vendor::dashboard.gender_other') }}</option>
                                </select>
                            </div>
