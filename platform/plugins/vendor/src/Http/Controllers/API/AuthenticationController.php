...
use Botble\Vendor\Http\Requests\LoginRequest;
use Botble\Vendor\Http\Requests\RegisterRequest;
use Botble\Vendor\Notifications\API\ConfirmEmailNotification;
