...
add_shortcode('info-teachers', 'All Teachers', 'All Teachers', function () {
    return Theme::partial('short-codes.info-teachers');
});
add_shortcode('info-testimonials', 'All Testimonials', 'All Testimonials', function () {
    return Theme::partial('short-codes.info-testimonials');
});
