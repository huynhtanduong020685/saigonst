...
<head>
    ...
    <!-- CSS Library-->
    <link rel="stylesheet" href="{{asset('css/banner-main.css')}}" media="all">
    
    <link rel="stylesheet" type="text/css" media="all" href="{{asset('css/teacher.css')}}">
    ...
    <!-- Style -->
    <link rel="stylesheet" href="{{asset('css/style-app.css')}}" media="all">
