<div class="rv-media-container">
    <div class="rv-media-wrapper">
        ...
        <aside class="rv-media-aside <?php if(config('core.media.media.sidebar_display') != 'vertical'): ?> rv-media-aside-hide-desktop <?php endif; ?>">
                    ...
                    <ul class="rv-media-aside-list">
                        <li>
                            <a href="#" class="js-rv-media-change-filter" data-type="filter" data-value="everything">
                                <i class="fa fa-recycle"></i> <?php echo e(trans('core/media::media.everything')); ?>

                            </a>
                        </li>
                        <?php if(array_key_exists('image', config('core.media.media.mime_types', []))): ?>
                            <li>
                                <a href="#" class="js-rv-media-change-filter" data-type="filter" data-value="image">
                                    <i class="fa fa-file-image"></i> <?php echo e(trans('core/media::media.image')); ?>

                                </a>
                            </li>
                        <?php endif; ?>
                        <?php if(array_key_exists('video', config('core.media.media.mime_types', []))): ?>
                            <li>
                                <a href="#" class="js-rv-media-change-filter" data-type="filter" data-value="video">
                                    <i class="fa fa-file-video"></i> <?php echo e(trans('core/media::media.video')); ?>
                        ...
                        <li>
                            <a href="#" class="js-rv-media-change-filter" data-type="filter" data-value="document">
                                <i class="fa fa-file"></i> <?php echo e(trans('core/media::media.document')); ?>
                    ...
                    <ul class="rv-media-aside-list">
                        <li>
                            <a href="#" class="js-rv-media-change-filter" data-type="view_in" data-value="all_media">
                                <i class="fa fa-globe"></i> <?php echo e(trans('core/media::media.all_media')); ?>
                        ...
                        <?php if(RvMedia::hasAnyPermission(['folders.destroy', 'files.destroy'])): ?>
                            <li>
                                <a href="#" class="js-rv-media-change-filter" data-type="view_in" data-value="trash">
                                    <i class="fa fa-trash"></i> <?php echo e(trans('core/media::media.trash')); ?>
                        ...
                        <li>
                            <a href="#" class="js-rv-media-change-filter" data-type="view_in" data-value="recent">
                                <i class="fa fa-clock"></i> <?php echo e(trans('core/media::media.recent')); ?>

                            </a>
                        </li>
                        <li>
                            <a href="#" class="js-rv-media-change-filter" data-type="view_in" data-value="favorites">
                                <i class="fa fa-star"></i> <?php echo e(trans('core/media::media.favorites')); ?>
        ...
        <div class="rv-media-main-wrapper">
                ...
                <div class="rv-media-top-header">
                    <div class="rv-media-actions">
                        ...
                        <?php if(RvMedia::hasPermission('files.create')): ?>
                            <button class="btn btn-success js-dropzone-upload">
                                <i class="fas fa-cloud-upload-alt"></i> <?php echo e(trans('core/media::media.upload')); ?>

                            </button>
                        <?php endif; ?>
                        <?php if(config('core.media.media.allow_external_services') && RvMedia::hasPermission('files.create')): ?>
                            <div class="btn-group" role="group">
                                <div class="dropdown">
                                    <button class="btn btn-success dropdown-toggle" type="button" data-toggle="dropdown">
                                        <i class="fa fa-plus"></i> <?php echo e(trans('core/media::media.add_from')); ?>

                                    </button>
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a href="#" data-toggle="modal" data-target="#modal_add_from_youtube">
                                                <i class="fab fa-youtube"></i> <?php echo e(trans('core/media::media.youtube')); ?>
                                        ...
                                        <?php if(app()->environment('demo')): ?>
                                            <li>
                                                <a href="#" data-toggle="modal" data-target="#modal_coming_soon">
                                                    <i class="fab fa-vimeo"></i> <?php echo e(trans('core/media::media.vimeo')); ?>

                                                </a>
                                            </li>
                                            <li>
                                                <a href="#" data-toggle="modal" data-target="#modal_coming_soon">
                                                    <i class="fab fa-vine"></i> <?php echo e(trans('core/media::media.vine')); ?>
                        ...
                        <?php if(RvMedia::hasPermission('folders.create')): ?>
                            <button class="btn btn-success" data-toggle="modal" data-target="#modal_add_folder">
                                <i class="fa fa-folder"></i> <?php echo e(trans('core/media::media.create_folder')); ?>

                            </button>
                        <?php endif; ?>
                        <button class="btn btn-success js-change-action" data-type="refresh">
                            <i class="fas fa-sync"></i> <?php echo e(trans('core/media::media.refresh')); ?>

                        </button>

                        <?php if(config('core.media.media.sidebar_display') != 'vertical'): ?>
                            <div class="btn-group" role="group">
                                <div class="dropdown">
                                    <button class="btn btn-success dropdown-toggle js-rv-media-change-filter-group" type="button" data-toggle="dropdown">
                                        <i class="fa fa-filter"></i> <?php echo e(trans('core/media::media.filter')); ?> <span class="js-rv-media-filter-current"></span>
                                    </button>
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a href="#" class="js-rv-media-change-filter" data-type="filter" data-value="everything">
                            ...
                            <div class="btn-group" role="group">
                                <div class="dropdown">
                                    <button class="btn btn-success dropdown-toggle js-rv-media-change-filter-group" type="button" data-toggle="dropdown">
                                        <i class="fa fa-eye"></i> <?php echo e(trans('core/media::media.view_in')); ?> <span class="js-rv-media-filter-current"></span>
                                    </button>
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a href="#" class="js-rv-media-change-filter" data-type="view_in" data-value="all_media">
                        ...
                        <?php if(RvMedia::hasAnyPermission(['folders.destroy', 'files.destroy'])): ?>
                            <button class="btn btn-danger js-files-action hidden" data-action="empty_trash">
                                <i class="fa fa-trash"></i> <?php echo e(trans('core/media::media.empty_trash')); ?>
                    ...
                    <div class="rv-media-search">
                        <form class="input-search-wrapper" action="" method="GET">
                            <input type="text" class="form-control" placeholder="<?php echo e(trans('core/media::media.search_file_and_folder')); ?>">
                        ...
                        <div class="btn-group" role="group">
                            <div class="dropdown">
                                <button class="btn btn-secondary dropdown-toggle"
                                    ...
                                    <?php echo e(trans('core/media::media.sort')); ?> <i class="fa fa-sort-alpha-down"></i>
                                </button>
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li>
                                        <a href="#"
                                           ...
                                           data-type="sort_by"
                                           data-value="name-asc">
                                            <i class="fas fa-sort-alpha-up"></i> <?php echo e(trans('core/media::media.file_name_asc')); ?>
                                    ...
                                    <li>
                                        <a href="#"
                                           ...
                                           data-value="name-desc">
                                            <i class="fas fa-sort-alpha-down"></i> <?php echo e(trans('core/media::media.file_name_desc')); ?>
                                    ...
                                    <li>
                                        <a href="#"
                                           ...
                                           data-value="created_at-asc">
                                            <i class="fas fa-sort-numeric-up"></i> <?php echo e(trans('core/media::media.created_date_asc')); ?>
                                    ...
                                    <li>
                                        <a href="#"
                                           ...
                                           data-value="created_at-desc">
                                            <i class="fas fa-sort-numeric-down"></i> <?php echo e(trans('core/media::media.created_date_desc')); ?>
                                    ...
                                    <li>
                                        <a href="#"
                                           ...
                                           data-value="updated_at-asc">
                                            <i class="fas fa-sort-numeric-up"></i> <?php echo e(trans('core/media::media.uploaded_date_asc')); ?>
                                    ...
                                    <li>
                                        <a href="#"
                                           ...
                                           data-value="updated_at-desc">
                                            <i class="fas fa-sort-numeric-down"></i> <?php echo e(trans('core/media::media.uploaded_date_desc')); ?>
                                    ...
                                    <li>
                                        <a href="#"
                                           ...
                                           data-type="sort_by"
                                           data-value="size-asc">
                                            <i class="fas fa-sort-numeric-up"></i> <?php echo e(trans('core/media::media.size_asc')); ?>
                                    ...
                                    <li>
                                        <a href="#"
                                           ...
                                           data-value="size-desc">
                                            <i class="fas fa-sort-numeric-down"></i> <?php echo e(trans('core/media::media.size_desc')); ?>
                            ...
                            <div class="dropdown rv-dropdown-actions disabled">
                                <button class="btn btn-secondary dropdown-toggle"
                                    ...
                                    <?php echo e(trans('core/media::media.actions')); ?> &nbsp;<i class="fa fa-ellipsis-v"></i>
                                </button>
            ...
            <footer class="rv-media-footer hidden">
                <button type="button" class="btn btn-danger btn-lg js-insert-to-editor"><?php echo e(trans('core/media::media.insert')); ?></button>
            </footer>
        </div>
        <div class="rv-upload-progress hide-the-pane">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><?php echo e(trans('core/media::media.upload_progress')); ?></h3>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">
                            <i class="fab fa-windows"></i> <?php echo e(trans('core/media::media.coming_soon')); ?>

                        </h4>
                        <button type="button" class="close" data-dismiss-modal="#modal_coming_soon" aria-label="<?php echo e(trans('core/media::media.close')); ?>">
        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="modal_add_from_youtube">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">
                            <i class="fab fa-windows"></i> <?php echo e(trans('core/media::media.add_from_youtube')); ?>

                        </h4>
                        <button type="button" class="close" data-dismiss-modal="#modal_add_from_youtube" aria-label="<?php echo e(trans('core/media::media.close')); ?>">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            <div class="input-group">
                                <label class="input-group-prepend custom-checkbox">
                                    ...
                                    <small><?php echo e(trans('core/media::media.playlist')); ?></small>
                                </label>
                                <input type="text" class="form-control rv-youtube-url" placeholder="https://">
                                <div class="input-group-prepend">
                                    <button class="btn btn-success rv-btn-add-youtube-url" type="button"><?php echo e(trans('core/media::media.add_url')); ?>
        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="modal_add_folder">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">
                            <i class="fab fa-windows"></i> <?php echo e(trans('core/media::media.create_folder')); ?>

                        </h4>
                        <button type="button" class="close" data-dismiss-modal="#modal_add_folder" aria-label="<?php echo e(trans('core/media::media.close')); ?>">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form class="rv-form form-add-folder">
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="<?php echo e(trans('core/media::media.folder_name')); ?>">
                                <div class="input-group-prepend">
                                    <button class="btn btn-success rv-btn-add-folder" type="submit"><?php echo e(trans('core/media::media.create')); ?></button>
                                </div>
                            </div>
                        </form>
                        <div class="modal-notice"></div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form class="rv-form form-rename">
                        <div class="modal-header">
                            <h4 class="modal-title">
                                <i class="fab fa-windows"></i> <?php echo e(trans('core/media::media.rename')); ?>

                            </h4>
                            <button type="button" class="close" data-dismiss-modal="#modal_rename_items" aria-label="<?php echo e(trans('core/media::media.close')); ?>">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss-modal="#modal_rename_items"><?php echo e(trans('core/media::media.close')); ?></button>
                            <button type="submit" class="btn btn-primary"><?php echo e(trans('core/media::media.save_changes')); ?></button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="modal-dialog modal-danger" role="document">
                <div class="modal-content">
                    <form class="rv-form form-delete-items">
                        <div class="modal-header">
                            <h4 class="modal-title">
                                <i class="fab fa-windows"></i> <?php echo e(trans('core/media::media.move_to_trash')); ?>

                            </h4>
                            <button type="button" class="close" data-dismiss-modal="#modal_trash_items" aria-label="<?php echo e(trans('core/media::media.close')); ?>">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-danger"><?php echo e(trans('core/media::media.confirm')); ?></button>
                            <button type="button" class="btn btn-primary" data-dismiss-modal="#modal_trash_items"><?php echo e(trans('core/media::media.close')); ?></button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="modal-dialog modal-danger" role="document">
                <div class="modal-content">
                    <form class="rv-form form-delete-items">
                        <div class="modal-header">
                            <h4 class="modal-title">
                                <i class="fab fa-windows"></i> <?php echo e(trans('core/media::media.confirm_delete')); ?>

                            </h4>
                            <button type="button" class="close" data-dismiss-modal="#modal_delete_items" aria-label="<?php echo e(trans('core/media::media.close')); ?>">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-danger"><?php echo e(trans('core/media::media.confirm')); ?></button>
                            <button type="button" class="btn btn-primary" data-dismiss-modal="#modal_delete_items"><?php echo e(trans('core/media::media.close')); ?></button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="modal-dialog modal-danger" role="document">
                <div class="modal-content">
                    <form class="rv-form form-empty-trash">
                        <div class="modal-header">
                            <h4 class="modal-title">
                                <i class="fab fa-windows"></i> <?php echo e(trans('core/media::media.empty_trash_title')); ?>

                            </h4>
                            <button type="button" class="close" data-dismiss-modal="#modal_empty_trash" aria-label="<?php echo e(trans('core/media::media.close')); ?>">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-danger"><?php echo e(trans('core/media::media.confirm')); ?></button>
                            <button type="button" class="btn btn-primary" data-dismiss-modal="#modal_empty_trash"><?php echo e(trans('core/media::media.close')); ?></button>
                        </div>
                    </form>
                </div>
            </div>
...
<?php /**PATH D:\WWW\saigonstar2020\platform/core/media/resources/views//content.blade.php ENDPATH**/ ?>